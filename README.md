...
| `iconStyle`      |         | `Stripe.StripeCardElementOptions['iconStyle']` | `'default'` | Stripe icon style.                                                                                |                |
| `value`          |         | `Stripe.StripeCardElementOptions['value']`     | `{}`        | Prefilled values for form.                                                                        |                |
| `brand`          |         | `Stripe.StripeCardElementChangeEvent['brand']` | `null`      | The card brand detected by Stripe                                                                 |                |
...
| `canMakePayment`    |         | `Stripe.CanMakePaymentResult`              | `null`      | Whether or not the device can make the payment request.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |                |
| `country`           |         | `CountryCode`                              |             | The two-letter country code of your Stripe account                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |                |
| `currency`          |         | `Stripe.PaymentRequestOptions['currency']` |             | Three character currency code                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |                |
...
| `paymentIntent`     |         | `Stripe.PaymentIntent`                     | `null`      | Stripe PaymentIntent                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |                |
| `paymentRequest`    |         | `Stripe.PaymentRequest`                    | `null`      | Stripe PaymentRequest                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |                |
...
| Name               | Privacy | Type                                    | Default | Description                   | Inherited From |
| ------------------ | ------- | --------------------------------------- | ------- | ----------------------------- | -------------- |
| `#displayItems`    | private | `Stripe.PaymentRequestItem[]`           |         |                               |                |
| `#shippingOptions` | private | `Stripe.PaymentRequestShippingOption[]` |         |                               |                |
